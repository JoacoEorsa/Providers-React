...
const dropdownVariants = tv({
  slots: {
    content: [
      "z-50 w-full min-w-32 overflow-hidden rounded-md border border-border-default-default",
      "bg-background-default-default p-1 text-text-default-default shadow-md",
      "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95",
      "data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95",
    ],
    item: [
      "relative flex w-full cursor-pointer items-center gap-2 rounded-sm px-2 py-1.5 text-sm font-medium outline-hidden select-none",
      "focus:bg-background-default-secondary focus:text-text-default-default data-disabled:pointer-events-none",
      "data-inset:pl-8",
      "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-text-brand-secondary",
    ],
    checkboxItem: [
    ...
    subTrigger: [
      ...
      "focus:bg-background-default-secondary focus:text-text-default-default data-inset:pl-8",
      "data-[state=open]:bg-background-default-secondary data-[state=open]:text-text-default-default",
    ],
    subContent: [
      "z-50 min-w-32 overflow-hidden rounded-md border border-border-default-default p-1",
      "bg-background-default-default text-text-default-default shadow-lg",
      "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
