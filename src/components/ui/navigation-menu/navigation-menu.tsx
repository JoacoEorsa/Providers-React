...
export const navigationVariants = tv({
  slots: {
    ...
    item: "relative",
    trigger: [
      "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background-default-default px-4 py-2 text-sm font-medium ring-background-brand-default/25 transition-[color,box-shadow]",
      "hover:bg-background-default-secondary hover:text-text-default-default focus:bg-background-default-secondary focus:text-text-default-default focus-visible:ring-4 focus-visible:outline-none",
      "disabled:pointer-events-none disabled:opacity-50",
      "data-[state=open]:bg-background-default-secondary/50 data-[state=open]:text-text-default-default data-[state=open]:hover:bg-background-default-secondary data-[state=open]:focus:bg-background-default-secondary",
    ],
    triggerIcon:
    ...
    link: [
      "flex flex-col gap-1 rounded-sm p-2 text-sm ring-background-brand-default/25 transition-[color,box-shadow]",
      "hover:bg-background-default-secondary hover:text-text-default-default focus:bg-background-default-secondary focus:text-text-default-default focus-visible:ring-4 focus-visible:outline-none",
      "data-[active=true]:bg-background-default-secondary/50 data-[active=true]:text-text-default-default data-[active=true]:hover:bg-background-default-secondary data-[active=true]:focus:bg-background-default-secondary",
      "[&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-text-brand-secondary",
    ],
    ...
    viewport: [
      "relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full origin-[top_center] overflow-hidden rounded-md border bg-background-default-default p-4 text-text-default-default shadow-lg",
