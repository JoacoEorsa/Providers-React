...
const radioGroupVariants = tv({
  slots: {
    root: "grid gap-3",
    item: [
      "peer aspect-square size-4 shrink-0 cursor-pointer rounded-full border border-border-neutral-tertiary shadow-xs transition-shadow outline-none",
      "focus-visible:ring-4 focus-visible:ring-background-brand-default/25 disabled:cursor-not-allowed disabled:border-border-disabled-default disabled:bg-background-disabled-default",
      "data-[state=checked]:bg-background-brand-default data-[state=checked]:text-icon-brand-on-brand data-[state=checked]:disabled:border-border-disabled-default data-[state=checked]:disabled:bg-background-disabled-default",
    ],
