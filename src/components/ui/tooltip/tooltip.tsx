...
const tooltipVariants = tv({
  slots: {
    content: [
      "z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-md bg-background-brand-default px-3 py-1.5 text-xs text-balance text-text-brand-on-brand animate-in fade-in-0 zoom-in-95",
